...
python /usr/bin/esmond-ps-load-gridftp -p /opt/esmond-gridftp/prp-maddash.calit2.optiputer.net.pickle -U http://prp-maddash.calit2.optiputer.net/esmond -u gridftp -k 93aacc45ecb4fc816c71022f3dfe81a65e96b60a -f /var/log/gridftp-transfer.log
deactivate
EOF
